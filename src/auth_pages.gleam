...
const styles = "<style>*{box-sizing:border-box}body{margin:0;background:#f2eee6;color:#10273c;font-family:Arial,sans-serif}.auth{min-height:100vh;display:grid;grid-template-columns:1fr 1fr}.auth-brand{background:#10273c;color:white;padding:8vw;display:flex;flex-direction:column;justify-content:space-between}.auth-brand a{color:white;font-weight:800;letter-spacing:.18em}.auth-brand h1{font:400 58px/1.05 Georgia;margin:30px 0}.auth-brand p{color:#b9c6ce;line-height:1.7}.auth-panel{display:grid;place-items:center;padding:40px}.auth-box{width:min(430px,100%)}.auth-box small{letter-spacing:.16em;color:#bd7045;font-weight:700}.auth-box h2{font:400 38px Georgia;margin:14px 0 8px}.auth-box>p{color:#66737b;line-height:1.6}.auth-form{display:grid;gap:17px;margin-top:30px}.auth-form label{font-size:11px;font-weight:700;display:grid;gap:8px}.auth-form input{width:100%;padding:15px;border:1px solid #cfd2ce;background:white;font-size:14px}.auth-form button{padding:16px;background:#bd7045;color:white;border:0;font-weight:700;cursor:pointer}.auth-links{display:flex;justify-content:space-between;margin-top:20px;font-size:12px}.auth-links a{color:#10273c}.notice{padding:13px 15px;background:#e7ddd0;border-left:3px solid #bd7045;font-size:12px;line-height:1.5;margin-top:20px}.error{background:#f4dede;border-color:#a64040;color:#7d2525}@media(max-width:760px){.auth{grid-template-columns:1fr}.auth-brand{padding:35px;min-height:260px}.auth-brand h1{font-size:40px}.auth-panel{padding:50px 22px}}</style>"
